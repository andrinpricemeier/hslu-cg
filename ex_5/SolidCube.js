...
export function SolidCube(gl, backColor, frontColor, rightColor, leftColor, topColor, bottomColor) {
    ...
    return {
        ...
        draw: function(gl, aVertexPositionId, aVertexColorId, aVertexTextureCoordId, aVertexNormalId, uModelMatrixId, angle) {
            
            const modelMatrix = mat4.create();
            mat4.translate(modelMatrix, modelMatrix, [-1, 0, 0]);
            mat4.rotate(modelMatrix, modelMatrix, angle, [0, 1, 0]);
            mat4.scale(modelMat, modelMat, [this.width, this.height, this.depth]);

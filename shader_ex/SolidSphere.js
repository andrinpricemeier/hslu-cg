 ...
 *
 */
export function SolidSphere(gl, latitudeBands, longitudeBands, color) {
    ...
    function draw(gl, aVertexPositionId, aVertexColorId, aVertexNormalId, uModelMatrixId, normalMatId, angle) {        

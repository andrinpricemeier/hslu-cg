 ...
 * @constructor
 */
export function SolidCube(gl, backColor, frontColor, rightColor, leftColor, topColor, bottomColor) {
    ...
    return {
        ...
        draw: function(gl, aVertexPositionId, aVertexColorId, aVertexTextureCoordId, aVertexNormalId, uModelMatrixId, normalMatId, angle) {
            ...
            gl.uniformMatrix3fv(normalMatId, false, normalMatrix);
